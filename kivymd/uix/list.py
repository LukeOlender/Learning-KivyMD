...
class BaseListItem(
    ...
    """
    Text font style. See ``kivymd.font_definitions.custompy``.
    ...
    """
    Font style for secondary line. See ``kivymd.font_definitions.custompy``.
    ...
    """
    Font style for tertiary line. See ``kivymd.font_definitions.custompy``.
